...
_See code: [src/commands/configure.ts](https://github.com/pacholoamit/pach-s-glorious-cli/blob/v2.7.0/src/commands/configure.ts)_
...
_See code: [src/commands/query.ts](https://github.com/pacholoamit/pach-s-glorious-cli/blob/v2.7.0/src/commands/query.ts)_
...
_See code: [src/commands/reports.ts](https://github.com/pacholoamit/pach-s-glorious-cli/blob/v2.7.0/src/commands/reports.ts)_
